...
@Component({
  selector: 'app-perfil-ventanilla',
  templateUrl: './perfil-ventanilla.component.html',
  styleUrls: ['./perfil-ventanilla.component.css']
})
export class PerfilVentanillaComponent implements OnInit{
