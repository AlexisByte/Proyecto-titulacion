...
@Component({
  selector: 'app-inicio-ventanilla',
  templateUrl: './inicio-ventanilla.component.html',
  styleUrls: ['./inicio-ventanilla.component.css']
})
export class InicioVentanillaComponent implements OnInit{
    // Tarjetas
    ...
    radarChartOptions: ChartOptions = {
      ...
      plugins: {
        legend: { display: true },
        title: { display: true, text: 'Métricas del Modelo X' }
      }
    };
